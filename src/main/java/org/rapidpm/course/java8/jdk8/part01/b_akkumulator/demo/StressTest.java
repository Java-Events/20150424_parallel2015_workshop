package org.rapidpm.course.java8.jdk8.part01.b_akkumulator.demo;
 ...
 * CyclicBarrier is used to control the threads and to eliminate the variation in thread creation and join overhead from the result.
 *
 */
